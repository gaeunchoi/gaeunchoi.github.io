---
layout : single
title :  "[12주차 과제]통 채우기(Bin Packing)"
...
1. First Fit, 최초 적합  
   ...
   결과는 다음과 같이 나온다.  
   ![FirstFit](../assets/images/FirstFit.png)  
   ```java
   import java.util.ArrayList;
...
2. Next Fit, 다음 적합
   ...
   결과는 다음과 같이 나온다.  
   ![NextFit](../assets/images/NextFit.png)   
   ```java
   import java.util.ArrayList;
...
3. Best Fit, 최선 적합  
   ...
   결과는 다음과 같이 나온다.  
   ![BestFit](../assets/images/BestFit.png)  
   ```java
   import java.util.ArrayList;
...
4. Worst Fit, 최악 적합
   ...
   결과는 다음과 같이 나온다.  
   ![WorstFit](../assets/images/WorstFit.png)
   ```java
   import java.util.ArrayList;
